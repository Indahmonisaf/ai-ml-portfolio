...
cuda = True
w = "E:/ai-ml-portfolio-folders/Computer Vision/Box Recognition Method and Computing Device/best4.onnx"
...
# Open video capture
video_capture = cv2.VideoCapture('E:/ai-ml-portfolio-folders/Computer Vision/Box Recognition Method and Computing Device/A3.mp4')

with open('E:/ai-ml-portfolio-folders/Computer Vision/Box Recognition Method and Computing Device/roi_coordinatesAnew2.txt', 'r') as file:
...
while True:
    ...
    image, ratio, dwdh = letterbox(image, new_shape=(256, 256), auto=False)
