...
cuda = True
w = "D:/PROJECT/PHA_project/new_yolov7/best4.onnx"
...
# Open video capture
video_capture = cv2.VideoCapture('D:/PHA_project/new_yolov7/test_data/A3.mp4')
...
out = cv2.VideoWriter('A3_ROI_result.avi', cv2.VideoWriter_fourcc('X', 'V', 'I', 'D'), 10, (frame_width, frame_height))
