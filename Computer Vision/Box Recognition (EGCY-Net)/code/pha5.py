...
img = cv2.imread('D:/new_yolov7/13.434.jpg')
...
# Call the count function to add class count labels
#count(class_counts, image)
...
for class_name, count in class_counts.items():
    ...
    tambah += 30
print("[INFO] Detecting Time {:.6f} second".format(end - start))
